...
if ( ! function_exists( 'rachievee_2024_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function rachievee_2024_posted_on() {
...
if ( ! function_exists( 'rachievee_2024_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function rachievee_2024_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html_x( 'by %s', 'post author', 'rachievee-2024' ),
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'rachievee-2024' ),
						array(
							'span' => array(
								'class' => array(),
							),
...
if ( ! function_exists( 'rachievee_2024_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function rachievee_2024_post_thumbnail() {
